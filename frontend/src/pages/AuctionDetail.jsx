...
const AuctionDetail = () => {
  ...
  //         <img
  //           src={auction.imageUrl || 'https://via.placeholder.com/800x300'}
  //           alt={auction.title}
  ...
  //               isEnded ? 'bg-gray-200 text-gray-800' : 'bg-green-100 text-green-800'
  //             }`}>
  ...
  //               <div>
  //                 <div className="flex items-center mb-2">
  //                   <FaGavel className="text-gray-500 mr-2" />
  //                   <span className="text-sm text-gray-600">Starting Price</span>
  //                 </div>
  //                 <p className="font-medium">${auction.startingPrice?.toFixed(2) || '0.00'}</p>
  //               </div>
  //               <div>
  //                 <div className="flex items-center mb-2">
  //                   <FaGavel className="text-gray-500 mr-2" />
  ...
  //                 </div>
  //                 <p className="text-xl font-bold">${auction.currentPrice?.toFixed(2) || '0.00'}</p>
  //               </div>
  //               <div>
  //                 <div className="flex items-center mb-2">
  ...
  //                 </div>
  //                 <p className={`font-medium ${isEnded ? 'text-red-600' : ''}`}>{timeLeft}</p>
  //               </div>
  //             </div>
  //           </div>
  //         </div>
            ...
            <div className="flex-1 p-6 flex flex-col">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-2">
                <div>
                  ...
                  <div className="font-medium text-gray-800">{auction.seller?.username || 'Unknown'}</div>
                </div>
                <div>
                  <div className="flex items-center text-sm text-gray-500 mb-1">
